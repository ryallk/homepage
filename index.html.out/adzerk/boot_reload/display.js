...
var attr = cljs.core.nth.call(null,vec__7763,(0),null);
...
var args7764 = [];
var len__7578__auto___7767 = arguments.length;
var i__7579__auto___7768 = (0);
while(true){
if((i__7579__auto___7768 < len__7578__auto___7767)){
args7764.push((arguments[i__7579__auto___7768]));

var G__7769 = (i__7579__auto___7768 + (1));
i__7579__auto___7768 = G__7769;
continue;
} else {
}
break;
...
var len__7578__auto___7772 = arguments.length;
var i__7579__auto___7773 = (0);
while(true){
if((i__7579__auto___7773 < len__7578__auto___7772)){
args__7585__auto__.push((arguments[i__7579__auto___7773]));

var G__7774 = (i__7579__auto___7773 + (1));
i__7579__auto___7773 = G__7774;
continue;
} else {
}
break;
...
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__7586__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq7771){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq7771));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__7775){
var map__7779 = p__7775;
var map__7779__$1 = ((((!((map__7779 == null)))?((((map__7779.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7779.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7779):map__7779);
var data = map__7779__$1;
var message = cljs.core.get.call(null,map__7779__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__7779__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__7779__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__7781 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__7781,goog.events.EventType.CLICK,((function (G__7781,map__7779,map__7779__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__7781,map__7779,map__7779__$1,data,message,line,file))
);

return G__7781;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__7782){
var map__7786 = p__7782;
var map__7786__$1 = ((((!((map__7786 == null)))?((((map__7786.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7786.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7786):map__7786);
var data = map__7786__$1;
var message = cljs.core.get.call(null,map__7786__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__7786__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__7786__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__7788 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str("at line "),cljs.core.str(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__7788,goog.events.EventType.CLICK,((function (G__7788,map__7786,map__7786__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__7788,map__7786,map__7786__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__7789){
var map__7793 = p__7789;
var map__7793__$1 = ((((!((map__7793 == null)))?((((map__7793.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7793.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7793):map__7793);
var messages = map__7793__$1;
var warnings = cljs.core.get.call(null,map__7793__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__7793__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__7795 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__7795,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__7795,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__7796){
var map__7799 = p__7796;
var map__7799__$1 = ((((!((map__7799 == null)))?((((map__7799.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7799.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7799):map__7799);
var messages = map__7799__$1;
var warnings = cljs.core.get.call(null,map__7799__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__7799__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__7799,map__7799__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__7799,map__7799__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__7799,map__7799__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__7799,map__7799__$1,messages,warnings,exception))
;
...
}catch (e7802){if((e7802 instanceof Error)){
var __7803 = e7802;
} else {
throw e7802;
